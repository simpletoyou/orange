...
const install = (Vue, vm) => {
	...
	Vue.prototype.$u.http.setConfig({
		...
		// baseUrl: 'https://www.luckybtc.co/api',
		// baseUrl: process.env.NODE_ENV === 'development' ? '/api' : "https://www.xbpysi.com/api",
		baseUrl: process.env.NODE_ENV === 'development' ? '/api' : "https://www.luckybtc.co/api",
